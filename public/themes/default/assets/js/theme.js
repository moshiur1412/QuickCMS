...
var getExactFolder = getExactUrl("themes/thema"); //input the theme folder name or application folder name; sample output will be: /themes/mythemes/thema because it is uses in the javascript that has other path
...
ga('create', 'UA-78374229-1', 'lancecoder.com');
ga('send', 'pageview');