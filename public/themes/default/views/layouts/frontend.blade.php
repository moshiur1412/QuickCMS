				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="{{ url('/') }}">
							...
							<img src="{{ !empty($generalSetting) ? '/upload/general_settings/'.$generalSetting->logo  : theme('images/logo.png')}}" alt="">
						</a>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-sm-6">
							<img alt="website template image" src="{{ !empty($generalSetting) ? '/upload/general_settings/'.$generalSetting->logo  : theme('images/logo.png')}}" style="height:40px; margin-bottom:20px;"> 
