            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sidebar-profile">
                    <div class="profile-main">
                        ...
                        <p> <span class="name">{{Auth::user()->name}}</span><br>
                            <span class="position" style="font-family: monospace;">{{Auth::user()->role}}</span>
                        </p>
                    </div>
                </li>
                @endif
                ...
                <li class="sub-menu  dcjq-parent-li"><a href="1" class="hvr-bounce-to-right-sidebar-parent dcjq-parent"><span class="fa fa-desktop fa-2x"></span><span>Layouts</span><span class="fa dcjq-icon"></span></a>
                    <ul class="sub" style="display: none;">
                        ...
                        <li > <a class="{{ Request::is('settings*') ? 'active' : '' }}"  href="{{ route('settings.create') }}">{{ trans('static.general_settings') }}</a></li>
                    @endif
                ...
                <li><a href="{{ route('products.index') }}" class="hvr-bounce-to-right-sidebar-parent {{ Request::is('products*') ? 'active' : '' }}"><span class="fa fa-product-hunt fa-2x"></span><span>{{ trans('static.products') }}</span></a> </li>

                <li><a href="{{ route('orders.index') }}" class="hvr-bounce-to-right-sidebar-parent {{ Request::is('orders*') ? 'active' : '' }}"><span class="fa fa-shopping-cart fa-2x"></span><span>{{ trans('static.orders') }}</span></a> </li>
        ...
        <div class="container-n top-page-header">
            ...
            <div class="page-breadcrumb">
                <nav class="c_breadcrumbs">
                    <ul>
                   <li><a href="{{url('/dashboard')}}"><i class="fa fa-home"></i> {{trans('static.dashboard')}}</a></li>
                   @for($i = 1; $i <= count(Request::segments()); $i++)
                       @if (!is_numeric(ucfirst(Request::segment($i))))
                          <li>
