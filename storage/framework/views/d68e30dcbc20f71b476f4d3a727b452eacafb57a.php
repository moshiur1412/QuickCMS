...
<div class="container">
	...
	<?php $__currentLoopData = $latest_watches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest_watch): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		<div class="col-md-2 letest-product-list">
			<a href="<?php echo e(route('single_product', $latest_watch->id)); ?>" title="<?php echo e($latest_watch->price); ?> TK."> <img src="<?php echo e(URL::to('/')); ?>/upload/products/<?php echo e($latest_watch->image); ?>" alt="<?php echo e($latest_watch->name); ?>" width="85px" height="85px"><p><?php echo e($latest_watch->name); ?></p></a>
		</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</div>
</div>
...
<div class="container products-categories">
	...
	<div class="col-md-9 best-product" style="border-left: 1px solid #D7D7D7;">
		<h3> <?php echo e(ucfirst($parameters)); ?> Brand Watches</h3>
		<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		<div class="col-md-3 best-product-list text-center">
			<h5><a href="<?php echo e(route('single_product', $category_product->id)); ?>"><?php echo e($category_product->name); ?> </a></h5>
			<a href="<?php echo e($category_product->name); ?> "><img src="<?php echo e(URL::to('/')); ?>/upload/products/<?php echo e($category_product->image); ?>" alt="" height="80px" width="80px"></a>
			<div class="price-details">
				<div class="price-number">
					<p><span class="rupees"><?php echo e($category_product->price); ?> TK. </span></p>
				</div>
				<div class="add-cart">								
						<h4><a href="<?php echo e(route('single_product', $category_product->id)); ?>">More Info</a></h4>
				</div>
			</div>
		</div>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
